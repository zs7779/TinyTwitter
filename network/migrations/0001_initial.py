    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_type', models.CharField(choices=[('IMG', 'Photo'), ('GIF', 'Animated Picture'), ('VID', 'Video')], default='IMG', max_length=3)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medias', to='network.post')),

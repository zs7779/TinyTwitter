...
# BIG BAD WARNING: bad practice in production below, this is so running without much setup is possible
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', "True") == "True"
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', "fubar") if DEBUG else os.getenv('DJANGO_SECRET_KEY')
#
